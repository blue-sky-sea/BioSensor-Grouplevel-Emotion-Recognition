...
global h10_address1
h10_address1="ED9ABF90-07B6-4137-A8FD-E1926DBF8B43"#Black polarh10

global h10_address2
h10_address2="2941575B-5A0D-4BDF-8661-86BB2A8014AB"#Orange polarh10

global h10_address3
h10_address3="C1296578-5172-4C4E-B5A7-A873B6747649"#blue polarh10
...
async def run():
    ...
    for d in devices:
        ...
        if(": Polar H10 9563FE26" in str(d)):
            global h10_address1
            h10_address1=str(d).replace(": Polar H10 9563FE26","")
            h10_address1.strip(" ")
            print("polar H10(Black) address:##",h10_address1,"##")

        ##My Orange Polar H10 96C3B524
        if(": Polar H10 96C3B524" in str(d)):
            global h10_address2
            h10_address2=str(d).replace(": Polar H10 96C3B524","")
            h10_address2.strip(" ")
            print("polar H10(Orange) address:##",h10_address2,"##")

        ##My Blue Polar H10 9A4EDB27
        if(": Polar H10 9A4EDB27" in str(d)):
            global h10_address3
            h10_address3=str(d).replace(": Polar H10(Blue) 9A4EDB27","")
            h10_address3.strip(" ")
            print("polar H10(Blue) address:##",h10_address3,"##")
...
#import asyncio
#from bleak import BleakClient
#E7:AF:00:96:72:DB: Polar H10 9563FE26 ED9ABF90-07B6-4137-A8FD-E1926DBF8B43
address = ""



if( h10_address1!=""):
    address = h10_address3
else:
    pass
...
async def run(client, debug=False):
    ...
    NUM=1000#total section number
    T=60*5#every T second record data to csv
